...
public abstract class ScrollRefreshLayout extends SwipeRefreshLayout {
    ...
    private void initAnim(){
        if (mTipOpenAnim == null || mTopCloseAnim == null){
            mTipOpenAnim = AnimationUtils.loadAnimation(mContext,R.animator.slide_top_in);
            mTopCloseAnim = AnimationUtils.loadAnimation(mContext,R.animator.slide_top_out);
